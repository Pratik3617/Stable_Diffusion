...
def generate(
        ...
        input_img=None, 
        strength=0.8, # how much attention to be paid to the input image
    ...
    if input_img:
        ...
        input_image_resized = input_img.resize((WIDTH, HEIGHT))
        input_image_tensor = np.array(input_image_resized)
        ...
        # run the image through encoder of the VAE
        ...
        # for text to image. start with random noise

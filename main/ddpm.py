...
class DDPMSampler:
    ...
    def get_variance(self, time_step: int) -> torch.Tensor:
        prev_t = self.get_previous_timestep(time_step)
    ...
    def step(self, time_step: int, latents: torch.Tensor, model_output: torch.Tensor):
        t = time_step
    ...
    def add_noise(self, original_samples: torch.FloatTensor, time_steps: torch.IntTensor) -> torch.FloatTensor:
        ...
        sqrt_one_minus_alpha_prod = (1 - alpha_cumprod[time_steps])**0.5 # standard deviation
